  ...
  const useCases = [
    {
      ...
      icon: '📄',
      color: 'nb-accent',
      features: ['Same-day funding', '90% advance rate', 'No hidden fees'],
      avgAmount: '$45K',
      avgAPY: '9.2%',
    },
    {
      ...
      icon: '💻',
      color: 'nb-accent-2',
      features: ['6-12x MRR available', 'Growth-friendly terms', 'No equity required'],
      avgAmount: '$120K',
      avgAPY: '11.8%',
    },
    {
      ...
      icon: '🎨',
      color: 'nb-purple',
      features: ['Platform agnostic', 'Revenue-based funding', 'Creator-friendly'],
      avgAmount: '$25K',
      avgAPY: '13.5%',
    },
    {
      ...
      icon: '🏠',
      color: 'nb-ok',
      features: ['Property-backed', 'Stable returns', 'Geographic diversity'],
      avgAmount: '$180K',
      avgAPY: '8.7%',
    },
    {
      ...
      icon: '💎',
      color: 'nb-pink',
      features: ['Premium assets', 'Exclusive access', 'High-yield potential'],
      avgAmount: '$350K',
      avgAPY: '15.2%',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-nb-ink/70 mb-8 max-w-3xl mx-auto">
            Transform your future cash flows into immediate capital. Choose your revenue type 
            and get personalized offers powered by AI risk scoring.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-12">
            ...
            <div className="flex items-center space-x-2">
              <TrendingUp className="text-nb-accent-2" size={20} />
              ...
              <NBCard className="h-full">
                <div className="space-y-4">
                  ...
                  <div className="flex items-start justify-between">
                    <div className={`w-12 h-12 bg-${useCase.color} rounded-nb flex items-center justify-center text-2xl`}>
                      {useCase.icon}
                    </div>
                    <div className="text-right">
                      <div className="text-xs text-nb-ink/60">Avg Amount</div>
                      <div className="font-bold">{useCase.avgAmount}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-nb-ink/10">
                    <div>
                      <div className="text-xs text-nb-ink/60">Avg APY</div>
                      <div className={`font-bold text-${useCase.color.replace('nb-', '')}`}>
                        {useCase.avgAPY}
                      </div>
                    </div>
                    <NBButton 
                      size="sm"
                      onClick={() => startFlow(useCase.id)}
        ...
        >
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { step: '1', title: 'Connect', description: 'Link your revenue source', icon: '🔗' },
              { step: '2', title: 'Analyze', description: 'AI evaluates your cash flow', icon: '🤖' },
              { step: '3', title: 'Offer', description: 'Get personalized terms', icon: '💰' },
              { step: '4', title: 'Fund', description: 'Receive instant capital', icon: '⚡' },
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
